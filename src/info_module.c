...
static PyObject* pyodbTables_method(PyObject* self, PyObject* args) 
{ 
Py_Initialize() ;
char *pytables[]  ={
"seqno@hdr",
...
static  PyObject pyodbVarno_method(PyObject* self, PyObject* args)
{
Py_Initialize() ;
char *vars[]={"$u", 
"$v",
...
for ( int i=0 ; i <= (sizeof (no ) /sizeof ( double)) -1  ; i++){
  printf (  "%s          %s          //%s \n" ,   vars[i], no[i], desc[i] ) ; 
...
static PyMethodDef module_methods[] = {
    {"pyodbTables",  (PyCFunction)(void(*)(void))   pyodbTables_method ,
     METH_VARARGS | METH_KEYWORDS,   "Show all existing ODB tables   "},
    {"pyodbVarno",  (PyCFunction)(void(*)(void))   pyodbVarno_method ,
     METH_VARARGS | METH_KEYWORDS,   "Print all ODB variables ,varno and description "},
